...
const TemplateList = () => {
  ...
  return (
    <div>
      <div>
        <h1>Refget schemas</h1>
        <h3>Search below to find schemas that belong to refget</h3>
      </div>
      <div>
        <Select
          options={options}
            ...
            <>
              <div className="fw-bold mt-2">
                <Breadcrumb>
                  ...
                  <Breadcrumb.Item href="https://ayobi.github.io/schemas/#/refget/">refget</Breadcrumb.Item>
